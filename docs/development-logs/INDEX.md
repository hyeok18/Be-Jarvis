...
| WU-15 | 30곳 실제 수직 통합 | 공통 | 진행 중 | 2026-08-26 | [최신 기록](./2026-08-26_WU-15_public-data-api.md) | Preview 실제 데이터·390/1440·개인 반응 검증 완료. Kakao Preview Config도 등록했으나 Kakao Console의 JavaScript SDK 도메인 등록·지도 사용 ON 대기; 이후 지도 SDK, 기존 테스트 계정의 체크인→공개 반응·거부/거리초과/재사용 smoke |
