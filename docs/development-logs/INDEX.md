...
| WU-15 | 30곳 실제 수직 통합 | 공통 | 진행 중 | 2026-08-26 | [최신 기록](./2026-08-26_WU-15_public-data-api.md) | Preview의 실제 데이터 390/1440 반응형·키보드 smoke와 비로그인 개인 반응 검증 완료. 기존 테스트 계정·위치 권한으로 체크인→공개 반응·거부/거리초과/재사용 smoke, Kakao 키가 준비되면 지도 SDK 확인 |
