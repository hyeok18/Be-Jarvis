...
| WU-16 | 발표 스냅샷·백업 모드 | B2+A1 | 진행 중 | 2026-08-26 | [기록](./2026-08-26_WU-16_presentation-snapshot.md), [인계](../HANDOFF_WU-15_WU-16_UI_BASELINE.md) | `?snapshot=1` 백업과 `?snapshot=1&cycle=1` 30초 순환 구현. 전체 test·typecheck·lint·Webpack build·HTTP 200 확인 완료. 390/1440px 눈검수와 3회 리허설은 재개 지점 |
