...
| WU-15 | 30곳 실제 수직 통합 | 공통 | 진행 중 | 2026-08-26 | [최신 기록](./2026-08-26_WU-15_public-data-api.md) | 스마트폰 체크인 API 로그에서 `enforce_reaction_abuse_guard` 403·`auth.users` 권한 오류 확인. 후속 `SECURITY DEFINER` migration 승인·적용 뒤 체크인 성공→반응→proof 재사용/권한 거부/거리초과 smoke 진행 |
