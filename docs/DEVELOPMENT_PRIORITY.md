...
| 17 | WU-16 | P0 | 발표 스냅샷·백업 모드 | B2+A1 | WU-15 | AC-14, AC-28 | 진행 중 | 시간 단축용 `?snapshot=1` 명시 백업 모드 구현·관련 테스트 18개·typecheck·lint·Webpack build·snapshot HTTP 200 통과. 30초 전환·390/1440px 시각 검증은 후속 세부 구현으로 이월 |
