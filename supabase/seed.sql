...
select
  ...
  (array[
    '성수 데모 소반', '성수 데모 면공방', '성수 데모 오븐골목', '성수 데모 달빛다방', '성수 데모 향신마당',
    '성수 데모 온기밥상', '성수 데모 국수창고', '성수 데모 작은오븐', '성수 데모 오후다방', '성수 데모 향신연구소',
    '성수 데모 밥상정원', '성수 데모 면의온도', '성수 데모 골목키친', '성수 데모 크림라운지', '성수 데모 아시아식탁',
    '성수 데모 한끼연구소', '성수 데모 국물공방', '성수 데모 파스타정류장', '성수 데모 브루잉룸', '성수 데모 향신상회',
    '성수 데모 밥꽃', '성수 데모 면담', '성수 데모 오븐산책', '성수 데모 디저트정류장', '성수 데모 아시아골목',
    '성수 데모 정담식당', '성수 데모 면과국물', '성수 데모 토마토키친', '성수 데모 낮잠카페', '성수 데모 향신소반'
  ]::text[])[fixture_no],
  category_name,
